...
import RecordQueryResult, { normalizeSortsOrGroups } from './record_query_result';
...
class View extends AbstractModel {
  ...
  selectRecords() {
    ...
    const normalizedOpts = RecordQueryResult._normalizeOpts(this.parentTable, this._viewDataStore.parentRecordStore, {
      ...opts,
