...
export class PerformRecordAction extends AbstractModelWithAsyncData {
  ...
  get _dataOrNullIfDeleted() {
    return invariant(false, 'The `data` property of PerformRecordAction should not be referenced');
  }
 ...
 *
 */
export function registerRecordActionDataCallback(callback) {
  const {
    performRecordAction
  } = sdk;
...
export function __injectSdkIntoPerformRecordAction(_sdk) {
  sdk = _sdk;
}