 ...
 * @internal
 */
function useUnwatchedRecordQueryResult_(tableOrViewOrQueryResult, functionNameForErrors, opts) {
  let queryResult;
  if (tableOrViewOrQueryResult instanceof Table || tableOrViewOrQueryResult instanceof View) {
    ...
    if (tableOrViewOrQueryResult instanceof RecordQueryResult && opts !== undefined) {
      throw spawnError('%s does not support passing both a queryResult and opts.', functionNameForErrors);
    }
 ...
 * @hook
 */
export function useRecordIds(tableOrViewOrQueryResult, opts) {
  const generatedOpts = tableOrViewOrQueryResult instanceof Table || tableOrViewOrQueryResult instanceof View ? {
  ...
  const queryResult = useUnwatchedRecordQueryResult_(tableOrViewOrQueryResult, 'useRecordIds', generatedOpts);
 ...
 * @hook
 */
export function useRecords(tableOrViewOrQueryResult, opts) {
  const queryResult = useUnwatchedRecordQueryResult_(tableOrViewOrQueryResult, 'useRecords', opts);
 ...
 * @hook
 */
export function useRecordById(tableOrViewOrQueryResult, recordId, opts) {
  const queryResult = useUnwatchedRecordQueryResult_(tableOrViewOrQueryResult, 'useRecordById', opts);
 ...
 * @hook
 */
export function useRecordQueryResult(tableOrViewOrQueryResult, opts) {
  const queryResult = useUnwatchedRecordQueryResult_(tableOrViewOrQueryResult, 'useRecordQueryResult', opts);
