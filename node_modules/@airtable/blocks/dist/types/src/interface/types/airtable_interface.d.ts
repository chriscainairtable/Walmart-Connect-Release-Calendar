import { type AirtableInterfaceCore, type AppInterface, type SdkInitDataCore } from '../../shared/types/airtable_interface_core';
...
/** @hidden */
export declare enum BlockInstallationPageElementCustomPropertyTypeForAirtableInterface {
    BOOLEAN = "boolean",
    STRING = "string",
    ENUM = "enum",
    FIELD_ID = "fieldId",
