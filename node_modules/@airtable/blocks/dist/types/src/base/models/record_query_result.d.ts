...
import { type ObjectValues, type FlowAnyFunction, type FlowAnyObject } from '../../shared/private_utils';
 ...
 */
export type WatchableRecordQueryResultKey = ObjectValues<typeof WatchableRecordQueryResultKeys> | string;
/** */
 ...
 */
declare abstract class RecordQueryResult<DataType = {}> extends AbstractModelWithAsyncData<DataType, WatchableRecordQueryResultKey> {
    /**
