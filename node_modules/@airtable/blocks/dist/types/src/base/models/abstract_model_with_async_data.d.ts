...
import { type FlowAnyFunction, type FlowAnyObject } from '../../shared/private_utils';
 ...
 */
declare abstract class AbstractModelWithAsyncData<DataType, WatchableKey extends string> extends AbstractModel<BaseSdkMode, DataType, WatchableKey> {
    /** @hidden */
